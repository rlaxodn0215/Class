// WinNet_Server.cpp : 애플리케이션에 대한 진입점을 정의합니다.
//

#define _WINSOCK_DEPRECATED_NO_WARNINGS

#include "framework.h"
#include "WinNet_Server.h"
                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_WINNETSERVER, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_WINNETSERVER));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_WINNETSERVER));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_WINNETSERVER);
...
int WinSocketTest_Server()
{
    ...
    {
        MessageBox(NULL, _T("socket binding failed"), _T("Error"), MB_OK);
        return 0;
    }

    else
    {
        MessageBox(NULL, _T("socket binding success"), _T("Success"), MB_OK);
    }
